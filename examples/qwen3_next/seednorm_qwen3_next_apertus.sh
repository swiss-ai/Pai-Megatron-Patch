...
#SBATCH --mem=460000
#SBATCH --output=/iopsstor/scratch/cscs/%u/Pai-Megatron-Patch/logs/slurm/training/SeedNorm-%x-%j.out
#SBATCH --error=/iopsstor/scratch/cscs/%u/Pai-Megatron-Patch/logs/slurm/training/SeedNorm-%x-%j.err
#SBATCH --no-requeue
